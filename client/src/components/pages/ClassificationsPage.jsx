const ClassificationsPage = () => {
    ...
    <div className="classifications">
        ...
        <ul>
            ...
            <li>
                <a href="https://www.bbfc.co.uk/rating/12" target="_blank" rel="noreferrer noopener">Rated 12A</a>
            ...
            <li>
                <a href="https://www.bbfc.co.uk/rating/15" target="_blank" rel="noreferrer noopener">Rated 15</a>
            ...
            <li>
                <a href="https://www.bbfc.co.uk/rating/18" target="_blank" rel="noreferrer noopener">Rated 18</a>
